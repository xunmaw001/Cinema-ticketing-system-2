...
public class DianyingOrderEntity<T> implements Serializable {
     ...
     * 场次
     */
    @ColumnInfo(comment="场次",type="int(11)")
    @TableField(value = "changci_types")

    private Integer changciTypes;
	 ...
	 * 获取：场次
	 */
    public Integer getChangciTypes() {
        return changciTypes;
    }
    /**
	 * 设置：场次
    ...
    public void setChangciTypes(Integer changciTypes) {
        this.changciTypes = changciTypes;
    }
    /**
	 * 获取：购买的座位
	 */

                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yingyuangoupiao/upload/dianyingCollectionMuBan.xls"
                        >批量导入电影收藏数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('dianyingCollection','导入导出')"
...
<script>
    ...
    //当前表下拉框搜索条件
        ...
        //评价
			...
			//评分
		    dianyingCollectionCommentbackPingfenNumber:0,
            };
        },
        created() {

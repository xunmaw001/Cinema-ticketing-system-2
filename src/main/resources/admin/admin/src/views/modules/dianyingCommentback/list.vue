        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yingyuangoupiao/upload/dianyingCommentbackMuBan.xls"
                        >批量导入电影评价数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('dianyingCommentback','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="dianyingCommentbackPingfenNumber"
                                      header-align="center"
                                      label="评分">
                        <template slot-scope="scope">
                            {{scope.row.dianyingCommentbackPingfenNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                ...
                dianyingId : null,
                yonghuId : null,
                dianyingCommentbackPingfenNumber : null,
            ...
            json_fields: {
                //级联表字段
                     ...
                     '账户状态': 'jinyongTypes',
                //本表字段
                     '评分': "dianyingCommentbackPingfenNumber",
        ...
        //评价
			...
			//评分
		    dianyingCommentbackCommentbackPingfenNumber:0,
            };
        },
        created() {
        ...
        methods: {
            ...
            wuyong(id) {
                ...
                _this.$confirm(`确定    操作?`, "提示", {confirmButtonText: "确定",cancelButtonText: "取消",type: "warning"
                    ...
                    _this.$http({
                        url: "dianyingCommentback/update",
                        method: "post",
                        data: {
                            id:id,
//                            dianyingCommentbackTypes:dianyingCommentbackTypes,
                        }
                    }).then(({data}) => {
                        if(data && data.code === 0){
